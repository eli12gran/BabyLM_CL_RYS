#!/usr/bin/env python
# NOTE: Paste this in strict/evaluation_pipeline/AoA_word/run_modified.py
import argparse
import logging
import pathlib
...
from evaluation_pipeline.AoA_word.evaluation_functions_modified import StepSurprisalExtractor
